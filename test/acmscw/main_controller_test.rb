...
module AcmScW
  class MainControllerTest < Test::Unit::TestCase
    ...
    def test_find_requested_page_file
      ...
      assert_equal 'securite-vie-privee/sponsoring.wtpl', MainController.find_requested_page_file('/securite-vie-privee/sponsoring.html')
      assert_equal 'securite-vie-privee/sponsoring.wtpl', MainController.find_requested_page_file('/securite-vie-privee/sponsoring.htm')
      assert_equal 'securite-vie-privee/sponsoring.wtpl', MainController.find_requested_page_file('/securite-vie-privee/sponsoring/')
      assert_equal 'securite-vie-privee/sponsoring.wtpl', MainController.find_requested_page_file('   /securite-vie-privee/sponsoring/   ')
    end
