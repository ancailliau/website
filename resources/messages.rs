...
activation_request_ok       "<p>Un e-mail vous permettant de réactiver votre compte vous a été envoyé. Veuillez suivre les instructions s'y trouvant.</p>"
...
invalid_product_id            "L'identifiant du produit est incorrect"

# About orders
invalid_product_id            "L'identifiant de la commande est incorrect"
