module AcmScW
  module Controllers
    ...
    class OrderController < ::Waw::ActionController
      ...
      def mark_order_as_delivered(params)
        order_services.mark_as_delivered(params.keep(:id)[:id], 1)
        :ok
      end
      ...
      def mark_order_as_undelivered(params)
        order_services.mark_as_delivered(params.keep(:id)[:id], 0)
        :ok
      end
